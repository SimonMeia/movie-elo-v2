  ...
  weeklabelcontainer: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        ...
        'text-surface-100 bg-primary-500': context.selected && !context.disabled
      },
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        ...
        'text-surface-100 bg-primary-500 dark:text-surface-0 dark:bg-primary-300/40': context.selected && !context.disabled
      },
